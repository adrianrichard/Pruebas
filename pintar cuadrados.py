...
class Segment(object):
    def __init__(self,game, x, y, alive):
        self.instance = game.c.create_rectangle(self.x * cell_size, self.y * cell_size, 
                                          self.x * cell_size + cell_size, self.y * cell_size + cell_size,fill="gray", tags="playbutton")
        self.instance = game.c.create_polygon(self.x * cell_size, self.y * cell_size, 
                                          self.x * cell_size + cell_size, self.y * cell_size + cell_size,fill="yellow")
        self.instance = game.c.create_polygon(self.x * cell_size, self.y * cell_size, 
                                          self.x * cell_size + cell_size, self.y * cell_size + cell_size,fill="red")
        self.instance = game.c.create_polygon(self.x * cell_size, self.y * cell_size, 
                                          self.x * cell_size + cell_size, self.y * cell_size + cell_size,fill="green")
        self.x = x
        self.y = y
        self.alive = alive
